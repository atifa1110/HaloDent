...
public class EditProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final String role = "Pasien";
                            ...
                            currentUser.updateProfile(request).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull @NotNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        ...
                                        Preference.setKeyUserAge(EditProfileActivity.this,Integer.parseInt(etUsia.getText().toString()));
                                        pasiens = new Pasiens(currentUser.getUid(),etNama.getText().toString(),currentUser.getEmail(),photo,etNomor.getText().toString(),status,role,etJenisKel.getText().toString(),etUsia.getText().toString(),etAlamat.getText().toString());

                                        databaseReference.child(currentUser.getUid()).setValue(pasiens).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull @NotNull Task<Void> task) {
                                                progress.dismiss();
